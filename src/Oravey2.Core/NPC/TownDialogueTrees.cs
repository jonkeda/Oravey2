        ...
        var nodes = new Dictionary<string, DialogueNode>
        {
            ...
            ["greeting"] = new DialogueNode(
                ...
                [
                    ...
                    new DialogueChoice("Any work?", NextNodeId: "quest_offer_1",
                    ...
                    new DialogueChoice("The rats are dead.", NextNodeId: "quest_1_complete",
                        Condition: new AndCondition(
                    ...
                    new DialogueChoice("Still working on it.", NextNodeId: null,
                        Condition: new AndCondition(
                            new FlagCondition("q_rat_hunt_active"),
                    ...
                    new DialogueChoice("Got another job?", NextNodeId: "quest_offer_2",
                        Condition: new AndCondition(
                    ...
                    new DialogueChoice("Working on the camp.", NextNodeId: null,
                        Condition: new AndCondition(
                    ...
                    new DialogueChoice("The camp is clear.", NextNodeId: "quest_3_complete",
                        Condition: new FlagCondition("q_safe_passage_active"),
                        Consequences: []),

                    // Post-completion
                    new DialogueChoice("How are things?", NextNodeId: "post_complete",
            ...
            ["quest_offer_1"] = new DialogueNode(
                ...
                Choices:
                [
                    new DialogueChoice("I'll handle it.", NextNodeId: null, Condition: null,
            ...
            ["quest_1_complete"] = new DialogueNode(
                ...
                Choices:
                [
                    new DialogueChoice("Thanks.", NextNodeId: null, Condition: null,
                        Consequences:
                        [
            ...
            ["quest_offer_2"] = new DialogueNode(
                ...
                Choices:
                [
                    new DialogueChoice("Consider it done.", NextNodeId: null, Condition: null,
                        Consequences: [new StartQuestAction("q_raider_camp")]),
                    new DialogueChoice("I need to prepare first.", NextNodeId: null, Condition: null, Consequences: []),
                ]),
            ...
            ["quest_3_complete"] = new DialogueNode(
                ...
                Choices:
                [
                    new DialogueChoice("Glad to help.", NextNodeId: null, Condition: null,
                        Consequences:
                        [
            ...
            ["post_complete"] = new DialogueNode(
                ...
                Choices:
                [
                    new DialogueChoice("Take care.", NextNodeId: null, Condition: null, Consequences: []),
                ]),
        };
