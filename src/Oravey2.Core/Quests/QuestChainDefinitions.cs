...
public static class QuestChainDefinitions
{
    ...
    /// </summary>
    public static QuestDefinition RatHunt() => new QuestDefinition {
        Id = "q_rat_hunt",
        Title = "Rat Problem",
    ...
    /// </summary>
    public static QuestDefinition RaiderCamp() => new QuestDefinition {
        Id = "q_raider_camp",
    ...
    /// </summary>
    public static QuestDefinition SafePassage() => new QuestDefinition {
        Id = "q_safe_passage",
        Title = "Safe Passage",
